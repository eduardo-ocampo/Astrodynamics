...
def plot():
    ...
    r = R.from_euler('yz', [inclination_angle,60], degrees=True)
    ...
    orbit_rot = go.Scatter3d(x=pos_rot[:,0], 
                            ...
                            name="Inclination = {} degrees & LAN = {} degrees".format(inclination_angle,lan),
    ...
    fig.update_layout(scene = dict(camera = camera,
                    ...
                    title={'text': "<b>Elliptical Orbit: Longitude of The Ascending Node (LAN) Change<b>",
                            'y':0.95,
                            'x':0.5,
                            'xanchor': 'center',
                            'yanchor': 'top'},
